...
input_file = "C:/Users/Ian.Horn/Documents/stac-repos/kyfromabove-stac/csv/phase3_orthos.csv"

output_dir = "../items/orthos/phase3"
...
def process_row(row):
    ...
    out_file = file_name.replace(".tif", ".json")
